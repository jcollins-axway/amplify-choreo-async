...
*/}}
{{- define "customer-id-aggregation.name" -}}
...
*/}}
{{- define "customer-id-aggregation.fullname" -}}
...
{{- define "customer-id-aggregation.description" -}}
...
*/}}
{{- define "customer-id-aggregation.chart" -}}
